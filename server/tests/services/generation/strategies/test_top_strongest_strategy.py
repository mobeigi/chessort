...
from fixtures.fixtures import random_position, random_move
...
def test_top_strongest_strategy():
    moves = [ 
        Move(id=1, position_id=position.id, uci_move="uci1", engine_eval="#1", engine_overall_rank=1),
        Move(id=2, position_id=position.id, uci_move="uci2", engine_eval="#2", engine_overall_rank=2),
        Move(id=3, position_id=position.id, uci_move="uci3", engine_eval="+200", engine_overall_rank=3),
        Move(id=4, position_id=position.id, uci_move="uci4", engine_eval="+200", engine_overall_rank=4),
        Move(id=5, position_id=position.id, uci_move="uci5", engine_eval="0", engine_overall_rank=5),
        Move(id=6, position_id=position.id, uci_move="uci6", engine_eval="0", engine_overall_rank=6),
        Move(id=7, position_id=position.id, uci_move="uci7", engine_eval="0", engine_overall_rank=7),
        Move(id=8, position_id=position.id, uci_move="uci8", engine_eval="-16", engine_overall_rank=8),
        Move(id=9, position_id=position.id, uci_move="uci9", engine_eval="-16", engine_overall_rank=9),
        Move(id=10, position_id=position.id, uci_move="uci10", engine_eval="#-5", engine_overall_rank=10),
     ]
    assert len(moves) == 10
